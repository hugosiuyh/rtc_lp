...
const ReviewForm: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    // Reference to the reviews sub-collection under the selected venue
    const reviewsSubCollectionRef = collection(db, `venues/${selectedVenue}/reviews`);
  
    // Add the review to the reviews sub-collection of the selected venue
    const reviewDocRef = doc(reviewsSubCollectionRef);
